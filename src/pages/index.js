...
export default function Home(props) {
  const [dataRoom, setDataRoom] = useSetState({});
        ...
        <div className={styles.oporto}>
          ...
          <div div className={styles.oporto__wellcome}>
            <div>
              ...
              <p>
                El Hotel Aparta-Hotel Oporto 83 está situado a sólo 15 minutos
                del aeropuerto internacional El Dorado. Nuestros huéspedes
                encontrarán un nuevo estilo de hospitalidad con una cálida
                bienvenida, instalaciones modernas, acceso ilimitado a Internet
                en todo el hotel, habitaciones confortables con ventanas y luz
                natural. Nuestros huéspedes pueden estar encantados con nuestros
                deliciosos desayunos. Cerca del hotel se encuentra el Centro
                Comercial Hayuelos, la Embajada de los Estados Unidos, Corferias
                y el Centro Deportivo de Alto Rendimiento. Además, el área
                financiera de la calle 26 donde se encuentran empresas globales
                como Unilever, Marsh, Daimler, GSK y Coca Cola. Por otro lado,
                si nuestros huéspedes están buscando un poco de diversión, cerca
                encontraran el centro comercial Salitre Plaza, Jardín Botánico,
                Centro Interactivo Maloka y Pricesmart. En coche y a 5 minutos
                se encuentran el centro comercial Gran Estación, el Parque
          ...
          <div className={styles.oporto__rewards}>
            ...
            <div className={styles.rewards__text}>
              ...
              <p>
                Haz parte de un club que te brindará beneficios en tus viajes
                con Oporto 83 Rewards. Un mundo de beneficios.
              </p>
              <p>
                Es facil, rapido y lo empiezas a disfrutar desde ya.
                ¡Inscríbete!{" "}
              </p>
